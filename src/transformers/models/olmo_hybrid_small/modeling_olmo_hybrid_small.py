...
class OlmoHybridSmallRMSNorm(nn.Module):
    def __init__(self, hidden_size, eps: float = 1e-6) -> None:
        """
        OlmoHybridSmallRMSNorm is equivalent to T5LayerNorm
        """
        super().__init__()
...
class OlmoHybridSmallRMSNormGated(nn.Module):
...
class OlmoHybridSmallMLP(nn.Module):
...
class OlmoHybridSmallDynamicCache:
    """
...
class OlmoHybridSmallShortConvolution(nn.Conv1d):
    def __init__(
        self,
        hidden_size: int,
        kernel_size: int,
...
class OlmoHybridSmallGatedDeltaNet(nn.Module):
    """
    ...
    def __init__(self, config: OlmoHybridSmallConfig, layer_idx: int):
        ...
        Conv1dClass = ShortConvolution if ShortConvolution is not None else OlmoHybridSmallShortConvolution
        ...
        self.o_norm = (
            OlmoHybridSmallRMSNormGated(self.head_v_dim, eps=1e-5)
    ...
    def forward(
        self,
        hidden_states: torch.Tensor,
        cache_params: OlmoHybridSmallDynamicCache | None = None,
...
class OlmoHybridSmallAttention(nn.Module):
    """
    ...
    def __init__(self, config: OlmoHybridSmallConfig, layer_idx: int):
        ...
        self.q_norm = OlmoHybridSmallRMSNorm(config.num_attention_heads * self.head_dim, config.rms_norm_eps)
        self.k_norm = OlmoHybridSmallRMSNorm(config.num_key_value_heads * self.head_dim, config.rms_norm_eps)
...
class OlmoHybridSmallAttentionDecoderLayer(GradientCheckpointingLayer):
    """
...
class OlmoHybridSmallLinearAttentionDecoderLayer(GradientCheckpointingLayer):
    """
...
class OlmoHybridSmallPreTrainedModel(PreTrainedModel):
...
class OlmoHybridSmallModel(OlmoHybridSmallPreTrainedModel):
    def __init__(self, config: OlmoHybridSmallConfig):
...
@auto_docstring
class OlmoHybridSmallForCausalLM(OlmoHybridSmallPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        super().__init__(config)
        self.model = OlmoHybridSmallModel(config)
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers import AutoTokenizer, OlmoHybridSmallForCausalLM

        >>> model = OlmoHybridSmallForCausalLM.from_pretrained("meta-olmo_hybrid_small/OlmoHybridSmall-2-7b-hf")
        >>> tokenizer = AutoTokenizer.from_pretrained("meta-olmo_hybrid_small/OlmoHybridSmall-2-7b-hf")
...
__all__ = ["OlmoHybridSmallForCausalLM", "OlmoHybridSmallModel", "OlmoHybridSmallPreTrainedModel"]
